...
struct ConfigAxis {
  ...
  uint32_t overrun_count;         // Core0 wrote N>1 packets before Core1 read: N-1 discarded per tick.
  uint32_t underrun_count;        // Core1 ran with no new Core0 packet (updated_from_c0 == 0).
  int8_t enabled;
