...
size_t serialize_joint_config(
  ...
  message.joint_config.step_pulse_len_ns = step_pulse_len_ns;
...
bool unpack_joint_config(
  ...
  printf("      invert_dir:   %u\n", reply->invert_dir);
  printf("      step_pulse:   %u ns\n", reply->step_pulse_len_ns);
  ...
  last_joint_config[joint].step_pulse_len_ns = reply->step_pulse_len_ns;
