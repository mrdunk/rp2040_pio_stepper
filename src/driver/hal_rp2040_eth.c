...
static const PinDef joint_pins[] = {
    ...
    { FLOAT, HAL_IN,  offsetof(skeleton_t, joint_step_pulse_len_cmd),   sizeof(hal_float_t*), "joint", 0, 1, "step-pulse-len-cmd"    }, // Commanded STEP pulse HIGH duration (µs, float); 0 = firmware default (~2.5µs)
};
