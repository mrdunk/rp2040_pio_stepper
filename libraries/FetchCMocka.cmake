...
if(cmocka_FOUND)
  # Use the system-installed cmocka.  Provide the unscoped "cmocka" target that
  # most test CMakeLists.txt entries link against, in addition to cmocka::cmocka.
  if(NOT TARGET cmocka)
    add_library(cmocka ALIAS cmocka::cmocka)
  endif()
else()
